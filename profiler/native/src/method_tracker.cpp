...
void ev31::method_tracker::start_method_compilation_timing(const std::size_t profiler_method_id,
                                                         const std::wstring& method_name)
{
    // Get the method map
    std::unordered_map<std::size_t, std::chrono::steady_clock::time_point>* method_map = nullptr;
    
    if (this->method_compilation_timing_map.find(method_name) != this->method_compilation_timing_map.end())
    {
        method_map = (this->method_compilation_timing_map.find(method_name))->second;
    }
    else
    {
        ...
        this->method_compilation_timing_map.insert({ method_name, method_map });
    }
...
void ev31::method_tracker::start_method_execution_timing(const std::size_t profiler_method_id,
                                                         const std::wstring& method_name)
{
    // Get the method map
    std::unordered_map<std::size_t, std::chrono::steady_clock::time_point>* method_map = nullptr;
    
    if (this->method_execution_timing_map.find(method_name) != this->method_execution_timing_map.end())
    {
        method_map = (this->method_execution_timing_map.find(method_name))->second;
    }
    else
    {
        // First time we have found, create it
        ...
        this->method_execution_timing_map.insert({ method_name, method_map });
    }
...
std::size_t ev31::method_tracker::stop_method_compilation_timing(const std::size_t profiler_method_id,
                                                               const std::wstring& method_name)
{
    // Get the method map
    std::unordered_map<std::size_t, std::chrono::steady_clock::time_point>* method_map = nullptr;
...
std::size_t ev31::method_tracker::stop_method_execution_timing(const std::size_t profiler_method_id,
                                                               const std::wstring& method_name)
{
    // Get the method map
    std::unordered_map<std::size_t, std::chrono::steady_clock::time_point>* method_map = nullptr;
