...
public class GcEventProjectorTests
{
    ...
    {
        return new EventRecord(ClrProviderName, "Test", eventId, version, timeStampQpc, threadId: 0, stackIndex: StackTable.EmptyStackIndex, fields: null, payloadBytes, payloadOffset: 0, payloadBytes.Length);
    }
    ...
    public void Project_IgnoresEventsFromOtherProviders()
    {
        ...
        EventRecord foreignEvent = new EventRecord("Some-Other-Provider", "Whatever", ClrGcEventIds.GCStart, version: 1, timeStampRelativeQpc: 0, threadId: 0, stackIndex: StackTable.EmptyStackIndex, fields: null, payload, payloadOffset: 0, payload.Length);
