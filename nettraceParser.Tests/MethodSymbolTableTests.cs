...
public class MethodSymbolTableTests
{
    ...
    public void MethodSymbolTable_Build_IgnoresEventsFromOtherProviders()
    {
        ...
        EventRecord foreignEvent = new EventRecord("Some-Other-Provider", eventName: null, ClrRundownEventIds.MethodDCStartVerbose, version: 1, timeStampRelativeQpc: 0, threadId: 0, stackIndex: StackTable.EmptyStackIndex, fields: null, foreignPayload, payloadOffset: 0, foreignPayload.Length);
    ...
    private static EventRecord MakeLoadEvent(long methodId, long startAddress, int size, string name, long qpc)
    {
        ...
        return new EventRecord("Microsoft-Windows-DotNETRuntime", eventName: null, ClrMethodEventIds.MethodLoadVerbose, version: 1, timeStampRelativeQpc: qpc, threadId: 0, stackIndex: StackTable.EmptyStackIndex, fields: null, payload, payloadOffset: 0, payload.Length);
    }
    ...
    private static EventRecord MakeUnloadEvent(long methodId, long qpc)
    {
        ...
        return new EventRecord("Microsoft-Windows-DotNETRuntime", eventName: null, ClrMethodEventIds.MethodUnloadVerbose, version: 1, timeStampRelativeQpc: qpc, threadId: 0, stackIndex: StackTable.EmptyStackIndex, fields: null, payload, payloadOffset: 0, payload.Length);
    }
